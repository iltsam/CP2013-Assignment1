...
public class PayrollGUI {
	...
	private void initialize() {
		...
		if(loadDetails.getActionListeners().length < 1) {
		...
		DeleteEmployeeListener deleteEmployeeListener = new DeleteEmployeeListener(this);
		if(deleteEmployeeBtn.getActionListeners().length < 1) {
			deleteEmployeeBtn.addActionListener(deleteEmployeeListener);
		}
		deleteEmployeeBtn.setFont(new Font("Tahoma", Font.BOLD, 11));
		deleteEmployeeBtn.setBackground(java.awt.Color.RED);
		GridBagConstraints gbc_deleteEmployeeBtn = new GridBagConstraints();
		gbc_deleteEmployeeBtn.insets = new Insets(0, 0, 5, 0);
		gbc_deleteEmployeeBtn.gridx = 7;
		gbc_deleteEmployeeBtn.gridy = 5;
		employeeDetailPanel.add(deleteEmployeeBtn, gbc_deleteEmployeeBtn);
...
//		}
	...
	public String getAffiliation() {
		return employeeUnion.getText();
	}
	
	public void setAffiliation(String union) {
		employeeUnion.setText(union);
	}
